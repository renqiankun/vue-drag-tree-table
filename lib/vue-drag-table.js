...
import { openBlock as u, createElementBlock as f, normalizeClass as w, normalizeStyle as S, renderSlot as v, Fragment as x, renderList as C, resolveComponent as p, createElementVNode as b, createBlock as I, withCtx as k, createVNode as q, withDirectives as N, withModifiers as M, vModelCheckbox as z, createCommentVNode as B, createTextVNode as T, toDisplayString as H, createSlots as R, createStaticVNode as F, vShow as P } from "vue";
const D = (t, s) => {
...
}, le = ["innerHTML"], ie = ["innerHTML"], oe = { key: 1 }, re = ["name"], de = { key: 2 }, ae = /* @__PURE__ */ F('<div class="hover-model" style="display:none;"><div class="hover-block prev-block"><i class="el-icon-caret-top"></i></div><div class="hover-block center-block"><i class="el-icon-caret-right"></i></div><div class="hover-block next-block"><i class="el-icon-caret-bottom"></i></div></div>', 1);
function ce(t, s, e, n, o, l) {
  ...
  return u(), f("div", {
      ...
      (u(!0), f(x, null, C(e.columns, (a, h) => (u(), I(r, {
        ...
        default: k(() => [
          a.type === "selection" ? (u(), f("span", se, [
            q(i, { depth: e.depth }, null, 8, ["depth"]),
    ...
    l.isFolder && l.currentIsOpen ? (u(!0), f(x, { key: 0 }, C(e.model[e.custom_field.lists], (a, h) => (u(), I(d, {
      model: a,
      columns: e.columns,
      key: h,
    ...
    ]), 1032, ["model", "columns", "isdraggable", "border", "depth", "custom_field", "onCheck", "expandRowKeys", "isContainChildren"]))), 128)) : B("", !0)
  ], 40, ee);
}
const O = /* @__PURE__ */ D($, [["render", ce]]), m = {
  clearHoverStatus() {
  ...
  methods: {
    ...
    filter(t, s) {
      ...
      for (let h = 0; h < e.length; h++) {
        const c = e[h], g = c.getBoundingClientRect(), y = g.left, _ = g.top, X = c.clientWidth, W = c.clientHeight;
        if (t > y && t < y + X && s > _ && s < _ + W) {
          const K = s - _, Y = c.getAttribute("tree-p-id");
          if (this.onlySameLevelCanDrag !== void 0 && Y !== window.dragPId)
            return;
          r = c.getAttribute("tree-id"), i = c.children[c.children.length - 1];
          let L = c.offsetHeight;
          if (K / L > 3 / 4)
            d = "bottom";
          else if (K / L > 1 / 4) {
      ...
      a == !1 || !i || (i.style.display = "block", O.offsetHeight, d == "bottom" ? i.children[2].style.opacity !== "0.5" && (m.clearHoverStatus(), i.children[2].style.opacity = 0.5) : d == "center" ? i.children[1].style.opacity !== "0.5" && (m.clearHoverStatus(), i.children[1].style.opacity = 0.5) : i.children[0].style.opacity !== "0.5" && (m.clearHoverStatus(), i.children[0].style.opacity = 0.5), this.targetId = r, this.whereInsert = d);
    },
    resetTreeData() {
